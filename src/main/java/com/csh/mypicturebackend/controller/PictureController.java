...
import com.csh.mypicturebackend.api.aliyunai.AliYunAiApi;
import com.csh.mypicturebackend.api.aliyunai.model.CreateOutPaintingTaskResponse;
import com.csh.mypicturebackend.api.aliyunai.model.GetOutPaintingTaskResponse;
import com.csh.mypicturebackend.api.imagesearch.ImageSearchApiFacade;
import com.csh.mypicturebackend.api.imagesearch.model.ImageSearchResult;
...
import com.csh.mypicturebackend.manager.SpaceUserAuthManager;
import com.csh.mypicturebackend.manager.auth.StpKit;
import com.csh.mypicturebackend.manager.auth.annotation.SaSpaceCheckPermission;
import com.csh.mypicturebackend.manager.auth.model.SpaceUserPermission;
import com.csh.mypicturebackend.manager.auth.model.SpaceUserPermissionConstant;
...
import com.csh.mypicturebackend.model.enums.PictureReviewStatusEnum;
import com.csh.mypicturebackend.model.vo.PictureTagCategory;
import com.csh.mypicturebackend.model.vo.PictureVO;
import com.csh.mypicturebackend.service.PictureService;
import com.csh.mypicturebackend.service.SpaceService;
...
//            }
    ...
    public BaseResponse<PictureTagCategory> listPictureTagCategory() {
        ...
        List<String> tagList = Arrays.asList("导管", "石细胞", "粘液细胞", "腺毛", "表皮细胞", "木质部", "维管束", "毛状体", "粗壁细胞", "淀粉粒");
        List<String> categoryList = Arrays.asList("根及根茎类", "藤木类", "皮类", "叶类", "花类", "果实及种子类", "全草类");
    ...
    public BaseResponse<Page<PictureVO>> listPictureVOByPageWithRedisCache(@RequestBody PictureQueryRequest pictureQueryRequest,
        ...
        String redisKey = "cshpicture:listPictureVOByPage:" + hashKey;
        // 从 Redis 缓存中查询
